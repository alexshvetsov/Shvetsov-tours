    ...
    return (
        <div className='contact-us'>
            ...
            <form className='contact-us__form'>
                ...
                <label htmlFor="name" className="contact-us__label">Name :{(showErrors && name.length===0) && <p className="contact-us__error">required *</p>} </label>
                ...
                <div className="contact-us__input-area">
                <label htmlFor="email" className="contact-us__label">Email :{(showErrors && name.length===0) && <p className="contact-us__error">required *</p>}</label>
                ...
                <div className="contact-us__input-area">
                <label htmlFor="message" className="contact-us__label">Message :{(showErrors && name.length===0) && <p className="contact-us__error">required *</p>}</label>
